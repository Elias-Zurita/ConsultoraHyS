    ...
    <>
      ...
      <div className="textosHome">
        ...
        <div className="mision">
          ...
          <p>
            Nuestra misión es garantizar entornos de trabajo seguros y
            saludables para todos nuestros clientes, implementando prácticas de
            seguridad efectivas y cumpliendo con las normativas vigentes.
            Creemos que un ambiente laboral seguro no solo protege a los
            empleados, sino que también mejora la eficiencia y productividad de
            las organizaciones.
          </p>
        </div>
        ...
        <div className="nuestrosServicios">
          ...
          <p>
            ...
            necesidades de nuestros diversos clientes, entre los cuales se
            incluyen:
          </p>
          <ul>
            <li>
              <strong>Mediciones:</strong> Realizamos mediciones precisas y
              detalladas de agentes físicos, químicos y biológicos en el
              ambiente laboral para identificar posibles riesgos y proponer
              soluciones efectivas.
            </li>
            <li>
              <strong>Auditorías:</strong> Llevamos a cabo auditorías de
              seguridad e higiene para evaluar el cumplimiento de las normativas
              y estándares de seguridad, y ayudamos a las empresas a implementar
              mejoras.
            </li>
            <li>
        ...
        <div className="compromiso">
          <h2>
            Nuestro <strong>Compromiso</strong>
          </h2>
          <p>
            En [Nombre de la Consultora], estamos comprometidos con la
            excelencia y la satisfacción del cliente. Nos enorgullece ofrecer
            servicios personalizados que se adaptan a las necesidades únicas de
            cada cliente. Nuestro objetivo es construir relaciones duraderas
            basadas en la confianza y la efectividad de nuestras soluciones.
          </p>
        </div>
        ...
        <div className="contactanos">
          ...
          <p>
            ...
            asesoramiento en higiene y seguridad, no dudes en ponerte en
            contacto con nosotros. Estamos aquí para ayudarte a crear un entorno
      ...
      <div className="bannerDesplazable">
